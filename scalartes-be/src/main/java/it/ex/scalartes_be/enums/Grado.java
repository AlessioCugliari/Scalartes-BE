...
public enum Grado implements Comparable<Grado> {
    ...
    GRADO_5A("5A", 7), GRADO_5A_PLUS("5A+", 8),
    GRADO_5B("5B", 9), GRADO_5B_PLUS("5B+", 10),
    GRADO_5C("5C", 11), GRADO_5C_PLUS("5C+", 12),

    // Dal 6A al 6C+
    GRADO_6A("6A", 13), GRADO_6A_PLUS("6A+", 14),
    GRADO_6B("6B", 15), GRADO_6B_PLUS("6B+", 16),
    GRADO_6C("6C", 17), GRADO_6C_PLUS("6C+", 18),

    // Dal 7A al 7C+
    GRADO_7A("7A", 19), GRADO_7A_PLUS("7A+", 20),
    GRADO_7B("7B", 21), GRADO_7B_PLUS("7B+", 22),
    GRADO_7C("7C", 23), GRADO_7C_PLUS("7C+", 24),

    // Dal 8A al 8C+
    GRADO_8A("8A", 25), GRADO_8A_PLUS("8A+", 26),
    GRADO_8B("8B", 27), GRADO_8B_PLUS("8B+", 28),
    GRADO_8C("8C", 29), GRADO_8C_PLUS("8C+", 30),

    // Dal 9A al 9B+
    GRADO_9A("9A", 31), GRADO_9A_PLUS("9A+", 32),
    GRADO_9B("9B", 33), GRADO_9B_PLUS("9B+", 34);
